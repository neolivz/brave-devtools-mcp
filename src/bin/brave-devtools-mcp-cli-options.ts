...
export const cliOptions = {
  autoConnect: {
    type: 'boolean',
    description:
      'If specified, automatically connects to a Brave browser running locally. Requires the remote debugging server to be started in the Brave instance via brave://inspect/#remote-debugging.',
  ...
  executablePath: {
    type: 'string',
    description: 'Path to custom Brave executable. Auto-detected if not provided.',
